class Admin::MarcadoresController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @marcador.save
        format.html { redirect_to [:admin, @marcador], notice: 'Marcador was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @marcador.update(marcador_params)
        format.html { redirect_to [:admin, @marcador], notice: 'Marcador was successfully updated.' }
  ...
  def destroy
    @marcador.destroy
    respond_to do |format|
      format.html { redirect_to admin_marcadores_url, notice: 'Marcador was successfully destroyed.' }
