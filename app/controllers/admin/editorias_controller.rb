class Admin::EditoriasController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @editoria.save
        format.html { redirect_to [:admin, @editoria], notice: 'Editoria was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @editoria.update(editoria_params)
        format.html { redirect_to [:admin, @editoria], notice: 'Editoria was successfully updated.' }
  ...
  def destroy
    @editoria.destroy
    respond_to do |format|
      format.html { redirect_to admin_editorias_url, notice: 'Editoria was successfully destroyed.' }
